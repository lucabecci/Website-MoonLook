    ...
    <Fragment>
      <Fragment>
        <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
          ...
          <div>
            <div className="inline-flex items-center justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-purple-600 hover:bg-purple-700 focus:shadow-outline focus:outline-none">
              CONTACTAR
            </div>
