            ...
            <div className="w-full lg:w-1/2 px-8">
              <div className="mb-12 lg:mb-0 pb-12 lg:pb-0 border-b lg:border-b-0">
                ...
                <p className="mb-8 leading-loose text-gray-500 dark:text-gray-300">
                  ...
                  utilizarlo. Nos gusta trabajar con sistemas complejos.
                  Actualmente trabajamos con las ultimas tecnologias del
                  mercado, como react, next, graphql, microservicios con
                  diferentes lenaguajes para mayor escalabilidad y mucho mas.
                </p>
