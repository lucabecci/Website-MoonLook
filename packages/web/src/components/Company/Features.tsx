      ...
      <div className="w-full lg:w-1/2 px-8">
        <ul className="space-y-12">
          <li className="flex -mx-4">
            <div className="px-4">
              <svg
                className="flex w-10 h-16 mx-auto items-center justify-center text-2xl font-bold font-heading rounded-full bg-white text-blue-600"
                viewBox="0 0 30 30"
                fill="none"
              >
                <path
            ...
            <div className="px-4">
              ...
              <p className="text-gray-500 dark:text-gray-300 leading-loose">
                Nos enfocamos en usar patrones y metodologias de buenas
                practicas para poder tener un codigo limpio, mantenible y
                escalable.
              </p>
            </div>
          </li>
          ...
          <li className="flex -mx-4">
            ...
            <div className="px-4">
              ...
              <p className="text-gray-500 dark:text-gray-300 leading-loose">
                Desarrollamos principalmente pensando en sistemas muy
                escalables, utilizamos las ultimas tecnologias para que nuestros
                sistemas sean escalables para el futuro.
              </p>
            </div>
          </li>
        </ul>
